...
export const metadata: Metadata = pageMetadata({ title: 'Contact — Your Name', description: 'Contact information, hiring availability, and professional links.', path: '/contact' });
...
export default function ContactPage() {
  return (
    <section className="relative z-10 mx-auto max-w-5xl px-5 py-24 md:px-10">
      ...
      <h1 className="mt-4 font-serif text-5xl font-black tracking-[-.05em] text-ink md:text-7xl">Let’s talk about useful interfaces.</h1>
      <p className="mt-6 max-w-2xl text-lg leading-8 text-muted">I am open to frontend engineering, design engineering, and product-minded full-stack opportunities. Replace the placeholder contact details before publishing.</p>
